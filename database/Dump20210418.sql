...
INSERT INTO `assignments` VALUES (51,88),(53,19),(54,12),(54,28),(54,81),(55,9),(57,15),(58,90),(59,25),(59,53),(61,13),(65,22),(67,84),(70,7),(70,91),(71,21),(73,14),(73,82),(74,8),(75,92),(76,27),(76,98),(78,10),(82,29),(90,30),(91,3),(92,24),(93,42),(96,89),(105,95),(108,115),(114,96),(117,17),(118,86),(120,1),(122,5),(123,20),(125,2),(125,11),(125,87),(130,33),(130,43),(130,48),(130,83),(131,18),(131,85),(132,26),(133,94),(134,6),(134,36),(134,52),(135,23),(136,4),(136,93),(137,97),(138,100),(140,16),(147,99);
...
CREATE TABLE `assigns` (
  ...
  KEY `fk2_idx` (`FMS_ID`),
  KEY `idx_Assign` (`Worker_ID`,`Complaint_ID`),
...
INSERT INTO `assigns` VALUES (142,9,1),(105,1,2),(142,10,3),(107,10,4),(55,9,5),(146,1,6),(77,10,7),(93,4,8),(94,10,9),(51,4,10),(60,4,11),(92,1,12),(52,10,13),(68,3,14),(109,4,15),(80,10,16),(147,8,17),(128,1,18),(148,2,19),(56,10,20),(64,4,21),(72,8,22),(96,6,23),(79,1,24),(65,5,25),(119,8,26),(131,2,27),(86,3,28),(72,10,29),(96,9,30),(56,8,31),(142,6,32),(130,1,33),(135,7,34),(71,7,35),(134,1,36),(90,1,37),(70,4,38),(137,5,39),(54,10,40),(103,2,41),(93,1,42),(130,1,43),(100,7,44),(126,9,45),(140,9,47),(130,1,48),(117,3,49),(114,1,50),(96,1,51),(134,1,52),(59,1,53),(51,1,54),(130,9,55),(104,6,56),(75,8,57),(56,7,59),(108,1,60),(74,7,61),(63,7,63),(100,4,64),(61,3,65),(124,10,66),(149,4,69),(71,7,81),(84,5,82),(51,8,83),(86,9,84),(135,2,85),(144,3,86),(136,9,87),(64,10,88),(115,1,89),(75,3,90),(99,9,91),(76,2,92),(107,5,93),(111,4,94),(91,7,95),(120,1,96),(89,7,97),(108,10,98),(102,10,99),(85,4,100),(73,1,114),(108,1,115);
...
--
-- Temporary view structure for view `complaint_assign`
--

DROP TABLE IF EXISTS `complaint_assign`;
/*!50001 DROP VIEW IF EXISTS `complaint_assign`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `complaint_assign` AS SELECT 
 1 AS `Complaint_ID`,
 1 AS `FMS_ID`,
 1 AS `Worker_ID`,
 1 AS `Rating`,
...
CREATE TABLE `complaints` (
  ...
  KEY `idx_reslovedanddate` (`Resolved`,`Start_time`),
...
INSERT INTO `fms_admin` VALUES (1,'2021-04-18 01:22:13'),(2,'2021-02-02 19:24:53'),(3,'2021-02-12 18:38:38'),(4,'2021-02-02 16:00:39'),(5,'2021-02-13 03:07:44'),(6,'2021-02-13 01:55:04'),(7,'2021-02-02 05:28:40'),(8,'2021-02-13 08:08:09'),(9,'2021-02-02 09:54:08'),(10,'2021-02-05 02:59:15');
/*!40000 ALTER TABLE `fms_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `fms_admin_update_complaint`
--

DROP TABLE IF EXISTS `fms_admin_update_complaint`;
/*!50001 DROP VIEW IF EXISTS `fms_admin_update_complaint`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `fms_admin_update_complaint` AS SELECT 
 1 AS `End_time`,
 1 AS `Resolved`,
 1 AS `Complaint_ID`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `hostel_room` (
  `Location_ID` mediumint NOT NULL,
  `Request_Active` tinyint NOT NULL,
  `Description` text,
...
CREATE TABLE `location` (
  ...
  `Last_Cleaned` datetime DEFAULT NULL,
  PRIMARY KEY (`Location_ID`),
  KEY `idx_Location` (`Last_Cleaned`,`Request_Active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `student3`
--
...
CREATE TABLE `students` (
  ...
  KEY `idx_students` (`Last_Health_Check`),
...
--
-- Temporary view structure for view `worker1`
--

DROP TABLE IF EXISTS `worker1`;
/*!50001 DROP VIEW IF EXISTS `worker1`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `worker1` AS SELECT 
 1 AS `ID`,
 1 AS `First_name`,
 1 AS `Last_name`,
 1 AS `Age`,
...
CREATE TABLE `workers` (
  ...
  `num_complaints` tinyint NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `idx_worker` (`Last_Assigned`,`num_complaints`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workers` VALUES (51,'Mrinmayi','Ismail',39,0,'+91 3402449810',23665,0,101,1,'2021-01-20 03:15:17',3),(52,'Lokajit','Patel',38,0,'+91 7097562993',23089,0,100,4,'2021-01-25 13:03:51',5),(53,'Anuga','Ismail',39,0,'+91 8394331165',31255,0,97,1,'2021-01-11 03:40:21',5),(54,'Shamshu','Singh',22,1,'+91 3049934629',22027,0,101,3,'2021-01-28 22:13:16',4),(55,'Dhanalakshmi','Singh',35,0,'+91 3530850575',21225,1,92,3,'2021-01-17 23:10:50',3),(56,'Ehimaya','Patel',28,1,'+91 4248571956',25798,0,100,3,'2021-01-27 14:01:48',4),(57,'Fahad','Singh',35,2,'+91 5060507601',25744,0,99,4,'2021-01-29 02:41:28',5),(58,'Kriday','Ismail',34,0,'+91 9619925372',23790,0,97,5,'2021-01-14 04:26:24',5),(59,'Valli','Singh',35,0,'+91 7310273903',30317,0,95,4,'2021-04-18 00:20:33',3),(60,'Monisha','Raj',31,0,'+91 7322758896',27267,0,95,2,'2021-01-13 04:36:52',5),(61,'Rajeev','Ismail',40,0,'+91 0200671729',28792,1,95,4,'2021-01-27 17:37:33',4),(62,'Kamali','Kumar',27,1,'+91 8122787319',20985,1,91,4,'2021-01-13 10:42:40',2),(63,'Chitramaya','Jain',29,1,'+91 2655131189',29843,1,92,3,'2021-01-26 20:25:05',3),(64,'Selma','Kumar',20,2,'+91 3390483408',31867,1,101,4,'2021-01-18 10:26:49',3),(65,'Vasuman','Ismail',36,0,'+91 2709633494',25672,1,91,1,'2021-01-11 12:48:56',2),(66,'Kulik','Singh',35,2,'+91 1485145164',23411,1,99,3,'2021-01-30 00:49:03',4),(67,'Waman','Kumar',39,2,'+91 7048370216',25980,0,98,4,'2021-01-04 12:43:41',3),(68,'Jayanti','Jain',34,1,'+91 5636748925',24520,0,97,1,'2021-01-30 21:31:59',4),(69,'Sapna','Raj',37,0,'+91 6854431622',33419,1,96,1,'2021-01-27 18:48:58',2),(70,'Hiral','Jain',32,0,'+91 0072996747',22185,0,101,2,'2021-01-21 21:41:07',5),(71,'Anjalika','Raj',37,1,'+91 3581114567',27709,1,91,4,'2021-01-01 18:47:40',2),(72,'Ananta','Singh',26,1,'+91 6403370412',32244,1,94,3,'2021-01-17 07:32:58',2),(73,'Mainak','Ismail',37,0,'+91 5135144267',23180,0,99,4,'2021-04-18 00:49:00',2),(74,'Virata','Patel',40,1,'+91 5689449859',23576,0,104,3,'2021-01-27 04:57:39',3),(75,'Anuprabha','Kumar',28,1,'+91 3504367219',24033,0,90,5,'2021-01-11 19:31:48',5),(76,'Mitali','Singh',34,0,'+91 1313814571',25107,0,96,1,'2021-01-08 00:30:01',3),(77,'Sudhir','Ismail',28,2,'+91 4466639577',31643,1,94,4,'2021-01-18 00:55:31',4),(78,'Mandara','Patel',31,0,'+91 2921221209',30851,0,99,4,'2021-01-26 18:01:37',5),(79,'Deeptiman','Khan',22,1,'+91 3288473757',22613,1,102,2,'2021-01-02 23:03:16',2),(80,'Nityananda','Jain',39,2,'+91 1611966667',21970,1,98,3,'2021-01-11 11:59:39',3),(81,'Faria','Singh',22,2,'+91 3625855830',31467,0,99,4,'2021-01-22 16:08:24',4),(82,'Sudhir','Ismail',26,1,'+91 7264715371',25709,0,97,4,'2021-01-25 08:42:24',2),(83,'Jagadeep','Kumar',31,2,'+91 2004378803',29366,1,99,2,'2021-01-16 06:28:44',4),(84,'Hans','Kumar',40,2,'+91 6975759166',27965,0,91,1,'2021-01-13 20:38:03',5),(85,'Kaliranjan','Ismail',34,0,'+91 6917901109',30250,1,90,1,'2021-01-29 03:29:16',4),(86,'Sharad','Raj',21,1,'+91 7018940424',25043,1,92,1,'2021-01-14 15:04:03',3),(87,'Shashank','Patel',37,1,'+91 7644152891',34572,0,90,4,'2021-01-28 23:35:23',4),(88,'Swetha','Raj',35,0,'+91 8496948578',30218,1,96,4,'2021-01-29 12:31:30',3),(89,'Adhik','Patel',23,1,'+91 4360944251',24029,1,95,4,'2021-01-20 15:06:45',4),(90,'Sahas','Kumar',35,1,'+91 2046289450',28966,0,103,4,'2021-01-03 20:02:38',2),(91,'Mukul','Ismail',37,2,'+91 2817758960',29480,1,103,1,'2021-01-23 03:58:56',5),(92,'Dayamayee','Patel',24,0,'+91 2161569874',26897,1,98,1,'2021-01-09 18:59:00',2),(93,'Ronak','Khan',34,1,'+91 6674066752',30201,0,100,3,'2021-04-18 00:22:38',4),(94,'Jhinuk','Khan',23,2,'+91 3930894820',21833,0,102,1,'2021-01-19 09:08:01',2),(95,'Rasaraj','Khan',23,0,'+91 1585051883',24405,1,97,2,'2021-01-09 15:52:16',3),(96,'Kishorekumar','Kumar',26,2,'+91 4872236068',28443,0,92,2,'2021-01-04 09:55:03',3),(97,'Kulbhushan','Kumar',23,1,'+91 9259736242',23721,1,99,1,'2021-01-12 20:01:35',3),(98,'Nityapriya','Singh',27,0,'+91 8246687762',25738,0,93,1,'2021-01-14 15:54:49',4),(99,'Hamir','Kumar',20,1,'+91 3769849517',24712,0,99,5,'2021-01-23 20:44:40',5),(100,'Suneeti','Jain',21,1,'+91 4465582752',33864,1,92,2,'2021-01-17 12:10:15',2),(101,'Bhanuprasad','Jain',36,2,'+91 3015835349',22678,1,98,3,'2021-01-05 01:18:16',2),(102,'Suhasini','Patel',38,2,'+91 5791303062',27816,1,104,3,'2021-01-07 21:13:39',4),(103,'Druthi','Raj',30,2,'+91 8763340811',34021,1,96,2,'2021-01-07 02:29:18',2),(104,'Rohini','Singh',20,1,'+91 5782795625',23011,1,94,4,'2021-01-11 18:22:12',4),(105,'Baridbaran','Jain',30,0,'+91 6447564250',27678,1,98,3,'2021-01-01 19:40:04',4),(106,'Mandhatri','Kumar',32,2,'+91 4573953221',25049,0,104,4,'2021-01-27 07:16:15',3),(107,'Kalindi','Ismail',37,0,'+91 4339533957',30125,1,98,3,'2021-01-05 02:56:00',5),(108,'Adalarasu','Raj',27,1,'+91 8136658701',31568,0,96,4,'2021-04-18 01:01:35',5),(109,'Mudra','Kumar',29,2,'+91 4176226895',26056,1,92,4,'2021-01-21 17:03:51',5),(110,'Anandi','Khan',21,1,'+91 9435259021',33401,1,104,3,'2021-01-31 13:02:26',4),(111,'Sibani','Patel',30,2,'+91 0870306614',32266,1,97,2,'2021-01-03 05:09:56',4),(112,'Sugita','Singh',36,2,'+91 5944862748',29414,1,98,2,'2021-01-10 16:09:36',5),(113,'Neelesh','Ismail',32,1,'+91 3405842377',31353,0,103,4,'2021-01-14 23:58:54',5),(114,'Jalil','Singh',28,0,'+91 3253007787',22860,1,99,3,'2021-01-27 12:07:55',5),(115,'Pulakesh','Khan',26,1,'+91 6796351270',21496,0,99,4,'2021-01-20 05:38:16',5),(116,'Malika','Khan',39,2,'+91 9287999606',32238,0,103,3,'2021-01-02 13:59:57',2),(117,'Kamalesh','Ismail',36,1,'+91 3533344992',25604,0,102,4,'2021-01-26 17:23:04',3),(118,'Vishwamitra','Khan',38,1,'+91 1690077146',29614,0,102,4,'2021-01-26 09:13:06',2),(119,'Gangika','Patel',23,2,'+91 8053882579',28522,1,94,3,'2021-01-04 23:08:27',2),(120,'Rambha','Khan',30,1,'+91 4513258685',28878,1,97,1,'2021-01-02 12:52:38',2),(121,'Suhrit','Singh',28,1,'+91 2617786851',20991,0,98,4,'2021-01-17 08:25:53',2),(122,'Paramananda','Patel',25,0,'+91 6339298578',32794,1,94,1,'2021-01-31 13:36:04',3),(123,'Pransukh','Patel',36,2,'+91 3952095837',26554,0,98,1,'2021-01-22 09:28:56',4),(124,'Kotijit','Patel',27,1,'+91 0952817388',32810,0,98,4,'2021-01-04 03:22:04',5),(125,'Amitabha','Singh',39,0,'+91 9611656195',33175,1,95,3,'2021-01-24 03:01:06',3),(126,'Rishabh','Kumar',23,0,'+91 0148608884',30149,1,95,3,'2021-01-24 22:56:42',3),(127,'Aishani','Patel',36,0,'+91 2600239578',23288,0,101,4,'2021-01-07 20:52:33',3),(128,'Ihitha','Jain',32,1,'+91 2328634255',24947,1,90,5,'2021-01-31 13:16:50',5),(129,'Ramani','Jain',34,0,'+91 7846086039',29121,1,95,2,'2021-01-13 06:13:20',5),(130,'Sultan','Singh',31,1,'+91 7360531858',20068,0,90,4,'2021-04-18 00:12:35',4),(131,'Induma','Kumar',22,0,'+91 4800992130',31451,0,93,4,'2021-01-22 03:13:09',3),(132,'Rajanigandha','Ismail',21,0,'+91 0311429774',26672,1,95,3,'2021-01-18 10:02:17',5),(133,'Jamuna','Patel',35,2,'+91 6353816669',21718,0,93,2,'2021-01-17 06:48:13',5),(134,'Tarakini','Kumar',39,2,'+91 9317543832',25703,0,94,3,'2021-04-18 00:16:34',2),(135,'Bhavesh','Jain',31,0,'+91 1663824836',23892,1,100,5,'2021-01-06 16:42:47',5),(136,'Vanajit','Ismail',35,0,'+91 0026509604',33794,1,102,2,'2021-01-29 17:20:22',5),(137,'Muniya','Kumar',26,1,'+91 9126745175',21730,1,92,3,'2021-01-26 13:27:52',5),(138,'Pasupati','Ismail',23,0,'+91 9644236787',22634,0,90,1,'2021-01-15 11:50:05',5),(139,'Vedika','Patel',33,1,'+91 9643749880',28104,1,102,3,'2021-01-11 19:14:54',2),(140,'Sunila','Patel',22,1,'+91 6055084742',32211,0,99,4,'2021-01-18 13:03:31',3),(141,'Raksha','Singh',29,0,'+91 9958675981',25524,0,99,4,'2021-01-16 06:02:23',3),(142,'Parantapa','Ismail',29,1,'+91 9670116698',26481,1,101,4,'2021-01-11 23:46:44',3),(143,'Swaha','Patel',20,1,'+91 9195736316',29133,0,94,4,'2021-01-08 17:11:25',4),(144,'Karishma','Ismail',31,0,'+91 5410694879',25595,1,94,1,'2021-01-08 16:44:42',5),(145,'Sushanta','Patel',34,2,'+91 1681988320',31404,0,102,4,'2021-01-29 13:27:54',4),(146,'Rishika','Kumar',35,0,'+91 4063206968',26821,1,101,4,'2021-01-19 05:39:22',4),(147,'Ratnabala','Kumar',38,1,'+91 1445662330',27967,1,104,1,'2021-01-11 15:06:14',5),(148,'Latif','Singh',20,0,'+91 8698666730',34911,1,102,4,'2021-01-10 13:50:27',2),(149,'Iraiyavan','Ismail',34,0,'+91 4090684048',20692,1,95,4,'2021-01-04 14:53:15',3),(150,'Nandan','Kumar',30,2,'+91 9099151297',24718,0,103,4,'2021-01-19 17:40:31',3);
...
--
-- Final view structure for view `complaint_assign`
--
...
/*!50001 VIEW `complaint_assign` AS select `assigns`.`Complaint_ID` AS `Complaint_ID`,`assigns`.`FMS_ID` AS `FMS_ID`,`assigns`.`Worker_ID` AS `Worker_ID`,`complaints`.`Rating` AS `Rating`,`complaints`.`Remarks` AS `Remarks` from (`assigns` join `complaints`) where (`complaints`.`Complaint_ID` = `assigns`.`Complaint_ID`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `currently_working`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `currently_working` AS select `workers`.`ID` AS `ID`,`workers`.`First_name` AS `First_name`,`workers`.`Last_name` AS `Last_name`,`workers`.`Age` AS `Age`,`workers`.`Gender` AS `Gender`,`workers`.`Contact_number` AS `Contact_number`,`workers`.`Salary` AS `Salary`,`workers`.`Duty` AS `Duty`,`workers`.`Temperature` AS `Temperature`,`workers`.`Avg_Rating` AS `Avg_Rating`,`workers`.`Last_Assigned` AS `Last_Assigned`,`workers`.`num_complaints` AS `num_complaints`,`assignments`.`Complaint_ID` AS `Complaint_ID` from (`workers` join `assignments` on((`workers`.`ID` = `assignments`.`ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `fms_admin_update_complaint`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `fms_admin_update_complaint` AS select `complaints`.`End_time` AS `End_time`,`complaints`.`Resolved` AS `Resolved`,`complaints`.`Complaint_ID` AS `Complaint_ID` from `complaints` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `student3` AS select `complaints`.`Remarks` AS `Remarks`,`complaints`.`Rating` AS `Rating`,`complaints`.`Complaint_ID` AS `Complaint_ID` from `complaints` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `worker1`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `worker1` AS select `workers`.`ID` AS `ID`,`workers`.`First_name` AS `First_name`,`workers`.`Last_name` AS `Last_name`,`workers`.`Age` AS `Age`,`workers`.`Gender` AS `Gender`,`workers`.`Contact_number` AS `Contact_number`,`workers`.`Duty` AS `Duty`,`workers`.`Temperature` AS `Temperature` from `workers` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-04-18  1:38:12
